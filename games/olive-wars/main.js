import { Game, PLAYER_DEFS, CANVAS_W, CANVAS_H } from './game.js?v=fall-arc4';
import { drawFrame } from './render.js?v=fall-arc4';
import { ChaseMusic } from './music.js?v=fall-arc4';
